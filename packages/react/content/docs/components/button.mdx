...
The Button is a fundamental interactive element that represents actionable commands within your interface. It enables
users to initiate processes, make selections, and interact with the website or application intuitively through clicks or
taps. Designed to clearly communicate available actions, the Button ensures that commands are executed simply and efficiently,
providing a consistent and accessible experience for users.
...
<Source
  ...
  code={
    dedent`
      npm i @ark-ui/react class-variance-authority clsx tailwind-merge
    `
  }
/>
